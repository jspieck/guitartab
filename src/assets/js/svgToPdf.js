    ...
    var SvgElemText = function(obj, inherits) {
      ...
      (function (textParentElem) {
        ...
        function recursive(currentElem, parentElem) {
          ...
          try {
             if("musicFont" == fontNameorLink){
                /*doc.font(musicFont);*/
                doc.font(musicFont);
            }else if("Source Sans Pro" == fontNameorLink){
                //console.log(fontNameorLink);
                doc.font(sansFont);
            }else if("notesFont" == fontNameorLink){
                doc.font(notesFont);
            }else{
                doc.font(fontNameorLink);
            }
            // doc.font(urrentElem.get('font-family'));
          } catch(e) {
