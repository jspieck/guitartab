let wavMaker = new (function () {
  let Wav = function (opt_params) {
    /**
     * @private
     */
    this._sampleRate =
  ...
  Wav.prototype.getWavInt16Array = function (buffer) {
    let intBuffer = new Int16Array(buffer.length + 23),
      tmp;
  ...
  this.writeFile = function (buffer, sampleRate) {
    ...
    const b = new Blob(srclist, { type: "audio/wav" });
