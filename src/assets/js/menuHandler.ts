...
class MenuHandler {
  ...
  constructor() {
    ...
    this.imagePaths = [
      ['playMusicImg', './images/playButton.svg', './images/playButtonWhite.svg'],
      ['zoomInImg', './images/zoomIn.svg', './images/zoomInWhite.svg'],
      ['zoomOutImg', './images/zoomOut.svg', './images/zoomOutWhite.svg'],
      ['wholeNoteImg', './images/notes/wholeNote.svg', './images/notes/wholeNoteWhite.svg'],
      ['halfNoteImg', './images/notes/halfNote.svg', './images/notes/halfNoteWhite.svg'],
      ['quarterNoteImg', './images/notes/quarterNote.svg', './images/notes/quarterNoteWhite.svg'],
      ['8thNoteImg', './images/notes/eighthNote.svg', './images/notes/eighthNoteWhite.svg'],
      ['16thNoteImg', './images/notes/16thNote.svg', './images/notes/16thNoteWhite.svg'],
      ['32ndNoteImg', './images/notes/32ndNote.svg', './images/notes/32ndNoteWhite.svg'],
      ['64thNoteImg', './images/notes/64thNote.svg', './images/notes/64thNoteWhite.svg'],
      ['dottedImg', './images/articulations/dotted.svg', './images/articulations/dottedWhite.svg'],
      ['doubleDottedImg', './images/articulations/doubleDotted.svg', './images/articulations/doubleDottedWhite.svg'],
      ['tupletImg', './images/articulations/tuplet.svg', './images/articulations/tupletWhite.svg'],
      ['tiedImg', './images/articulations/tied.svg', './images/articulations/tiedWhite.svg'],
      ['infoImg', './images/info.svg', './images/infoWhite.svg'],
      ['downloadIDGP', './images/saveOwn.svg', './images/saveOwnWhite.svg'],
      ['classicalToggle', './images/classicalToggle.svg', './images/classicalToggleWhite.svg'],
      ['pullDownImg', './images/articulations/hammerOn.svg', './images/articulations/hammerOnWhite.svg'],
      ['slideImg', './images/articulations/Slide.svg', './images/articulations/SlideWhite.svg'],
      ['bendImg', './images/articulations/bend.svg', './images/articulations/bendWhite.svg'],
      ['trillImg', './images/articulations/Triller.svg', './images/articulations/TrillerWhite.svg'],
      ['tremoloPickingImg', './images/articulations/tremoloPicking.svg', './images/articulations/tremoloPickingWhite.svg'],
      ['tremoloBarImg', './images/articulations/tremoloBar.svg', './images/articulations/tremoloBarWhite.svg'],
      ['deadImg', './images/articulations/dead.svg', './images/articulations/deadWhite.svg'],
      ['stacattoImg', './images/articulations/Stacatto.svg', './images/articulations/StacattoWhite.svg'],
      ['palmMuteImg', './images/articulations/PalmMute.svg', './images/articulations/PalmMuteWhite.svg'],
      ['fadeInImg', './images/articulations/fadeIn.svg', './images/articulations/fadeInWhite.svg'],
      ['vibratoImg', './images/articulations/vibrato.svg', './images/articulations/vibratoWhite.svg'],
      ['graceImg', './images/articulations/grace.svg', './images/articulations/graceWhite.svg'],
      ['artificialImg', './images/articulations/artificial.svg', './images/articulations/artificialWhite.svg'],
      ['ghostNoteImg', './images/articulations/brackets.svg', './images/articulations/bracketsWhite.svg'],
      ['accentuatedImg', './images/articulations/Accentuated.svg', './images/articulations/AccentuatedWhite.svg'],
      ['heavyAccentuatedImg', './images/articulations/heavyAccentuated.svg', './images/articulations/heavyAccentuatedWhite.svg'],
      ['strokeImg', ' ./images/articulations/stroke.svg', ' ./images/articulations/strokeWhite.svg'],
      ['letRingImg', ' ./images/articulations/letRing.svg', ' ./images/articulations/letRingWhite.svg'],

      ['timeMeterImg', './images/statusBar/denom.svg', './images/statusBar/denomWhite.svg'],
      ['bpmMeterImg', './images/statusBar/bpmMeter.svg', './images/statusBar/bpmMeterWhite.svg'],
      ['addMeasureImg', ' ./images/statusBar/addMeasure.svg', './images/statusBar/addMeasureWhite.svg'],
      ['removeMeasureImg', ' ./images/statusBar/removeMeasure.svg', './images/statusBar/removeMeasureWhite.svg'],
      ['openBarImg', './images/statusBar/openBar.svg', './images/statusBar/openBarWhite.svg'],
      ['closeBarImg', './images/statusBar/closeBar.svg', './images/statusBar/closeBarWhite.svg'],
      ['repeatAlternativeImg', './images/statusBar/repeatAlternative.svg', './images/statusBar/repeatAlternativeWhite.svg'],

      ['addChordImg', './images/statusBar/chord.svg', './images/statusBar/chordWhite.svg'],
      ['addTextImg', './images/statusBar/text.svg', './images/statusBar/textWhite.svg'],
      ['addMarkerImg', './images/statusBar/marker.svg', './images/statusBar/markerWhite.svg'],
      ['pauseMusicImg', './images/pause.svg', './images/pauseWhite.svg'],
      ['oneMeasureBackImg', './images/statusBar/backward.svg', './images/statusBar/backwardWhite.svg'],
      ['oneMeasureForwardImg', './images/statusBar/forward.svg', './images/statusBar/forwardWhite.svg'],
      ['sequencerEditImg', './images/cogWheel.svg', './images/cogWheelWhite.svg'],
      ['sequencerAddInstrument', './images/addInstrument.svg', './images/addInstrumentWhite.svg'],
      ['sequencerToggle', './images/sequencerToggle.svg', './images/sequencerToggleWhite.svg'],
      ['fullscreenImg', './images/fullscreen.svg', './images/fullscreenWhite.svg'],
      ['chordSection', './images/chordSection.svg', './images/chordSectionWhite.svg'],
    ];
    this.initYPos = 0;
    this.oldBpm = 90;
    this.lastVoiceId = 0;
