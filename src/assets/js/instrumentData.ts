...
const instrumentList: {[a: string]: [string, string, number, number]} = {
  piano: ['./images/instrumentIcons/myPianoDesign.svg', 'Grand Piano', 0, 0.15], // 1.6
  brightPiano: ['./images/instrumentIcons/myPianoDesign.svg', 'Bright Piano', 1, 0.3], // 1.6
  electricGrand: ['./images/instrumentIcons/myPianoDesign.svg', 'Electric Grand Piano', 2, 0.15], // 1.6
  honkyTonk: ['./images/instrumentIcons/myPianoDesign.svg', 'Honky Tonk Piano', 3, 0.1], // 1.6
  epiano1: ['./images/instrumentIcons/myPianoDesign.svg', 'E-Piano 1', 4, 0.15], // 1.6
  epiano2: ['./images/instrumentIcons/myPianoDesign.svg', 'E-Piano 2', 5, 0.3], // 1.6
  harpsichord: ['./images/instrumentIcons/myHarpsichordDesign.svg', 'Harpsichord', 6, 0.4], // 1.6
  clavinet: ['./images/instrumentIcons/myClavinetDesign.svg', 'Clavinet', 7, 0.4], // 1.6

  celesta: ['./images/instrumentIcons/myCelestaDesign.svg', 'Celesta', 8, 1.0],
  glockenspiel: ['./images/instrumentIcons/myGlockenspielDesign.svg', 'Glockenspiel', 9, 1.0],
  musicbox: ['./images/instrumentIcons/myMusicBoxDesign.svg', 'Musicbox', 10, 1.0],
  vibraphone: ['./images/instrumentIcons/myVibraphoneDesign.svg', 'Vibraphone', 11, 1.0],
  marimba: ['./images/instrumentIcons/myMarimbaDesign.svg', 'Marimba', 12, 1.0],
  xylophone: ['./images/instrumentIcons/myXylophoneDesign.svg', 'Xilophone', 13, 1.0],
  tubularBells: ['./images/instrumentIcons/myTubularBellsDesign.svg', 'Tubular Bells', 14, 1.0],
  dulcimer: ['./images/instrumentIcons/myDulcimerDesign.svg', 'Dulcimer', 15, 1.0],

  organ: ['./images/instrumentIcons/myOrganDesign.svg', 'Drawbar Organ', 16, 0.7],
  percussiveOrgan: ['./images/instrumentIcons/myOrganDesign.svg', 'Percussive Organ', 16, 0.7],
  rockOrgan: ['./images/instrumentIcons/myOrganDesign.svg', 'Rock Organ', 18, 0.7],
  churchOrgan: ['./images/instrumentIcons/myOrganDesign.svg', 'Church Organ', 19, 0.5],
  reedOrgan: ['./images/instrumentIcons/myOrganDesign.svg', 'Reed Organ', 20, 0.5],
  accordion: ['./images/instrumentIcons/myAccordionDesign.svg', 'Accordion', 21, 0.1],
  harmonica: ['./images/instrumentIcons/myHarmonicaDesign.svg', 'Harmonica', 22, 0.5],
  bandoneon: ['./images/instrumentIcons/myBandoneonDesign.svg', 'Bandoneon', 23, 0.5],

  guitar: ['./images/instrumentIcons/myAccGuitarDesign.svg', 'Acoustic Guitar', 24, 0.6],
  nylonGuitar: ['./images/instrumentIcons/myAccGuitarDesign.svg', 'Western Guitar', 25, 0.6],
  eguitar: ['./images/instrumentIcons/myGuitarDesign.svg', 'E-Guitar', 26, 0.6],
  overdriveguitar: ['./images/instrumentIcons/myGuitarDesign.svg', 'Overdrive E-Guitar', 29, 0.10],
  disteguitar: ['./images/instrumentIcons/myGuitarDesign.svg', 'Distorted E-Guitar', 30, 0.10],
  mutedGuitar: ['./images/instrumentIcons/myGuitarDesign.svg', 'Muted E-Guitar', 30, 0.4],
  bass: ['./images/instrumentIcons/myBassDesign.svg', 'Bass', 33, 1.0],

  drums: ['./images/instrumentIcons/myDrumsDesign.svg', 'Drums', 10, 1.0],

  violin: ['./images/instrumentIcons/myViolinDesign.svg', 'Violin', 40, 0.5],
  viola: ['./images/instrumentIcons/myViolinDesign.svg', 'Viola', 41, 0.5],
  cello: ['./images/instrumentIcons/myViolinDesign.svg', 'Cello', 42, 0.5],
  contrabass: ['./images/instrumentIcons/myViolinDesign.svg', 'Contrabass', 43, 0.6],
  tremoloStrings: ['./images/instrumentIcons/myViolinDesign.svg', 'Tremolo Strings', 44, 0.6],
  pizzicatoStrings: ['./images/instrumentIcons/myViolinDesign.svg', 'Pizzicato Strings', 45, 1.0],
  harp: ['./images/instrumentIcons/myHarpDesign.svg', 'Harp', 46, 0.6],
  timpani: ['./images/instrumentIcons/myTimpaniDesign.svg', 'Timpani', 47, 0.3],

  strings: ['./images/instrumentIcons/myViolinDesign.svg', 'Strings', 48, 0.075],
  synthStrings1: ['./images/instrumentIcons/myViolinDesign.svg', 'Synth Strings 1', 50, 0.4],
  synthStrings2: ['./images/instrumentIcons/myViolinDesign.svg', 'Synth Strings 2', 51, 0.6],
  voicesAah: ['./images/instrumentIcons/myVoiceDesign.svg', 'Voices Aah', 52, 1.5],
  voicesOoh: ['./images/instrumentIcons/myVoiceDesign.svg', 'Voices Ooh', 53, 1.5],
  synthlead: ['./images/instrumentIcons/myVoiceDesign.svg', 'Voice', 54, 0.4],
  orchestraHit: ['./images/instrumentIcons/myViolinDesign.svg', 'Orchestra Hit', 55, 0.6],

  trumpet: ['./images/instrumentIcons/myTrumpetDesign.svg', 'Trumpet', 56, 0.5],
  trombone: ['./images/instrumentIcons/myTromboneDesign.svg', 'Trombone', 57, 0.5],
  tuba: ['./images/instrumentIcons/myTubaDesign.svg', 'Tuba', 58, 0.5],
  mutedTrumpet: ['./images/instrumentIcons/myTrumpetDesign.svg', 'Muted Trumpet', 59, 0.5],
  frenchHorn: ['./images/instrumentIcons/myFrenchHornDesign.svg', 'French Horn', 60, 0.2],
  brassSection: ['./images/instrumentIcons/myBrassDesign.svg', 'Brass Section', 61, 0.4],
  synthBrass1: ['./images/instrumentIcons/myBrassDesign.svg', 'Synth Brass 1', 62, 0.3],
  synthBrass2: ['./images/instrumentIcons/myBrassDesign.svg', 'Synth Brass 2', 63, 0.3],

  sopranoSax: ['./images/instrumentIcons/mySaxDesign.svg', 'Soprano Saxophone', 64, 1.2],
  altoSax: ['./images/instrumentIcons/mySaxDesign.svg', 'Alto Saxophone', 65, 0.5],
  tenorSax: ['./images/instrumentIcons/mySaxDesign.svg', 'Tenor Saxophone', 66, 0.8],
  baritoneSax: ['./images/instrumentIcons/mySaxDesign.svg', 'Baritone Saxophone', 67, 0.8],
  oboe: ['./images/instrumentIcons/myOboeDesign.svg', 'Oboe', 68, 1.0],
  englishHorn: ['./images/instrumentIcons/myOboeDesign.svg', 'English Horn', 69, 1.0],
  bassoon: ['./images/instrumentIcons/myBassoonDesign.svg', 'Bassoon', 70, 1.4],
  clarinet: ['./images/instrumentIcons/myClarinetDesign.svg', 'Clarinet', 71, 1.0],

  piccolo: ['./images/instrumentIcons/myPiccoloDesign.svg', 'Piccolo', 72, 0.9],
  flute: ['./images/instrumentIcons/myFluteDesign.svg', 'Flute', 73, 0.2],
  recorder: ['./images/instrumentIcons/myFluteDesign.svg', 'Recorder', 74, 3.0],
  panFlute: ['./images/instrumentIcons/myFluteDesign.svg', 'Pan Flute', 75, 0.4],
  blownBottle: ['./images/instrumentIcons/myBottleDesign.svg', 'Blown Bottle', 76, 0.5],
  shakuhachi: ['./images/instrumentIcons/myShakuhachiDesign.svg', 'Shakuhachi', 77, 0.3],
  whistle: ['./images/instrumentIcons/myWhistleDesign.svg', 'Whistle', 78, 0.3],
  ocarina: ['./images/instrumentIcons/myOcarinaDesign.svg', 'Ocarina', 79, 0.3],

  lead1: ['./images/instrumentIcons/myLeadDesign.svg', 'Square Lead', 80, 0.7],
  lead2: ['./images/instrumentIcons/myLeadDesign.svg', 'Saw Lead', 81, 0.7],
  lead3: ['./images/instrumentIcons/myLeadDesign.svg', 'Calliope Lead', 82, 0.7],
  lead4: ['./images/instrumentIcons/myLeadDesign.svg', 'Chiff Lead', 83, 0.7],
  lead5: ['./images/instrumentIcons/myLeadDesign.svg', 'Charang Lead', 84, 0.7],
  lead6: ['./images/instrumentIcons/myLeadDesign.svg', 'Voice Lead', 85, 0.7],
  lead7: ['./images/instrumentIcons/myLeadDesign.svg', 'Fifths Lead', 86, 0.7],
  lead8: ['./images/instrumentIcons/myLeadDesign.svg', 'Bass+Lead Lead', 87, 0.7],

  pad1: ['./images/instrumentIcons/myPadDesign.svg', 'New Age Pad', 88, 1.0],
  pad2: ['./images/instrumentIcons/myPadDesign.svg', 'Warm Pad', 89, 1.0],
  pad3: ['./images/instrumentIcons/myPadDesign.svg', 'Polysynth Pad', 90, 1.0],
  pad4: ['./images/instrumentIcons/myPadDesign.svg', 'Choir Pad', 91, 1.0],
  pad5: ['./images/instrumentIcons/myPadDesign.svg', 'Bowed Pad', 92, 1.0],
  pad6: ['./images/instrumentIcons/myPadDesign.svg', 'Metallic Pad', 93, 1.0],
  pad7: ['./images/instrumentIcons/myPadDesign.svg', 'Halo Pad', 94, 1.0],
  pad8: ['./images/instrumentIcons/myPadDesign.svg', 'Sweep Pad', 95, 1.0],

  fx1: ['./images/instrumentIcons/myFXDesign.svg', 'Rain FX', 96, 1.0],
  fx2: ['./images/instrumentIcons/myFXDesign.svg', 'Soundtrack FX', 97, 1.0],
  fx3: ['./images/instrumentIcons/myFXDesign.svg', 'Crystal FX', 98, 1.0],
  fx4: ['./images/instrumentIcons/myFXDesign.svg', 'Atmosphere FX', 99, 1.0],
  fx5: ['./images/instrumentIcons/myFXDesign.svg', 'Brightness FX', 100, 1.0],
  fx6: ['./images/instrumentIcons/myFXDesign.svg', 'Goblins FX', 101, 1.0],
  fx7: ['./images/instrumentIcons/myFXDesign.svg', 'Echoes FX', 102, 1.0],
  fx8: ['./images/instrumentIcons/myFXDesign.svg', 'Sci-Fi FX', 103, 1.0],

  sitar: ['./images/instrumentIcons/mySitarDesign.svg', 'Sitar', 104, 0.5],
  banjo: ['./images/instrumentIcons/myBanjoDesign.svg', 'Banjo', 105, 0.5],
  shamisen: ['./images/instrumentIcons/myShamisenDesign.svg', 'Shamisen', 106, 0.5],
  koto: ['./images/instrumentIcons/myKotoDesign.svg', 'Koto', 107, 0.5],
  kalimba: ['./images/instrumentIcons/myKalimbaDesign.svg', 'Kalimba', 108, 0.5],
  bagpipe: ['./images/instrumentIcons/myBagpipeDesign.svg', 'Bagpipe', 109, 0.5],
  fiddle: ['./images/instrumentIcons/myViolinDesign.svg', 'Fiddle', 110, 0.5],
  shanai: ['./images/instrumentIcons/myShanaiDesign.svg', 'Shanai', 111, 0.5],

  tinkleBell: ['./images/instrumentIcons/myTinkleBellDesign.svg', 'Tinkle Bell', 112, 0.4],
  agogo: ['./images/instrumentIcons/myAgogoDesign.svg', 'Agogo Bells', 113, 0.4],
  steelDrum: ['./images/instrumentIcons/mySteelDrumDesign.svg', 'Steel Drum', 114, 0.4],
  woodblock: ['./images/instrumentIcons/myWoodblockDesign.svg', 'Woodblock', 115, 0.4],
  taiko: ['./images/instrumentIcons/myTaikoDesign.svg', 'Taiko Drum', 116, 0.4],
  melodicTom: ['./images/instrumentIcons/myTomDesign.svg', 'Melodic Tom', 117, 0.4],
  synthDrum: ['./images/instrumentIcons/mySynthDrumDesign.svg', 'Synth Drum', 118, 0.4],
  reverseCymbal: ['./images/instrumentIcons/myWoodblockDesign.svg', 'Reverse Cymbal', 119, 0.4],

  guitarFretNoise: ['./images/instrumentIcons/myFXDesign.svg', 'Guitar Fret Noise', 120, 0.4],
  breathNoise: ['./images/instrumentIcons/myFXDesign.svg', 'Breath Noise', 121, 0.4],
  seashore: ['./images/instrumentIcons/myFXDesign.svg', 'Seashore', 122, 0.4],
  birdTweet: ['./images/instrumentIcons/myFXDesign.svg', 'Bird Tweet', 123, 0.4],
  telephoneRing: ['./images/instrumentIcons/myFXDesign.svg', 'Telephone Ring', 124, 0.4],
  helicopter: ['./images/instrumentIcons/myFXDesign.svg', 'Helicopter', 125, 0.4],
  applause: ['./images/instrumentIcons/myFXDesign.svg', 'Applause', 126, 0.4],
  gunshot: ['./images/instrumentIcons/myFXDesign.svg', 'Gunshot', 127, 0.4],
};
