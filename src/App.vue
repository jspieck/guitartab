      ...
      <div class="modalBody">
        ...
        <div id="fNodeContainer1" class="filterNodeContainer">
          <div class="filterNodeSetting">
            ...
            <div class="equalizerModeSelectBox select">
              <select id="equalizerModeSelect1">
            ...
            <div id="qualityContainer1" class="knob qualityKnob">
              <!--<svg class="knobRing"><circle id="innerRing1" stroke="#226aa9" stroke-width="2" fill="transparent" r="10" cx="11" cy="11" stroke-dasharray="62.83185 62.83185" stroke-dashoffset="55.8505"></circle></svg>
                        <div id="qualityKnob1" data-id="1" class="panKnobInner"></div>-->
            </div>
        ...
        <div id="fNodeContainer2" class="filterNodeContainer">
          <div class="filterNodeSetting">
            <label class="modeLabel">Mode</label>
            <div class="equalizerModeSelectBox select">
              <select id="equalizerModeSelect2">
                <option value="lowpass">Lowpass</option>
                <option value="highpass">Highpass</option>
                <option value="bandpass">Bandpass</option>
                <option value="lowshelf">Lowshelf</option>
          ...
          <label class="qualityLabel">Quality (Q)</label>
          <div id="qualityContainer2" class="knob qualityKnob">
              <!--<div id="qualityKnob2" data-id="2" class="panKnobInner"></div>
                        <svg class="knobRing">
                            <circle id="innerRing2" stroke="#226aa9" stroke-width="2" fill="transparent" r="10" cx="11" cy="11" stroke-dasharray="62.83185 62.83185" stroke-dashoffset="55.8505"></circle>
                        </svg>-->
            </div>
        ...
        <div id="fNodeContainer3" class="filterNodeContainer">
          <div class="filterNodeSetting">
            <label class="modeLabel">Mode</label>
            <div class="equalizerModeSelectBox select">
              <select id="equalizerModeSelect3">
                <option value="lowpass">Lowpass</option>
                <option value="highpass">Highpass</option>
                <option value="bandpass">Bandpass</option>
                <option value="lowshelf">Lowshelf</option>
            ...
            <label class="qualityLabel">Quality (Q)</label>
            <div id="qualityContainer3" class="knob qualityKnob">
              <!--<svg class="knobRing"><circle id="innerRing3" stroke="#226aa9" stroke-width="2" fill="transparent" r="10" cx="11" cy="11" stroke-dasharray="62.83185 62.83185" stroke-dashoffset="55.8505"></circle></svg>
                        <div id="qualityKnob3" data-id="3" class="panKnobInner"></div>-->
            </div>
